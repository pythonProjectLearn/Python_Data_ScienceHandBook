...
class DeepFM(object):
    """
    Deep ch18_FM with FTRL optimization
    """
    def __init__(self, config):
        ...
        # num of fields
        self.field_cnt = field_cnt # 有21个离散特征
    ...
    def inference(self):
        ...
        # add ch18_FM output and DNN output
        # 两个因子输出的和
    ...
    def train(self):
        ...
        # 获得graph中可以更新的变量,在训练时只更新需要训练的变量,
...
def validation_model(sess, model, print_every=50):
    ...
    validation_data = pd.read_csv('/home/zt/Documents/Data/avazu_CTR/train.csv', chunksize=model.batch_size)
    # testing step
    valid_step = 1
    # batch_size data
